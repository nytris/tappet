...
use Tappet\Runner\Standard\Arrangement\AssertionArrangement;
use Tappet\Tests\AbstractTestCase;

/**
 * Class AssertionArrangementTest.
 *
 * @author Dan Phillimore <dan@ovms.co>
 */
class AssertionArrangementTest extends AbstractTestCase
{
    private AssertionInterface&MockInterface $assertion;
    private AssertionArrangement $arrangement;
    ...
    public function setUp(): void
    {
        ...
        $this->arrangement = new AssertionArrangement($this->assertion);
    }

    public function testGetAssertionReturnsAssertion(): void
    {
        static::assertSame($this->assertion, $this->arrangement->getAssertion());
    }
