 ...
 */
class HoverTest extends AbstractTestCase
{
    private Hover $action;
    ...
    public function setUp(): void
    {
        ...
        $this->action = new Hover('user-menu');
    }

    public function testGetInteractionHandleReturnsInteractionHandle(): void
    {
        static::assertSame('user-menu', $this->action->getInteractionHandle());
    }
