...
/**
 * Class ExpectSelectedRadioOption.
 *
 * Asserts that the given radio button group field has the specified option selected.
 *
 * @author Dan Phillimore <dan@ovms.co>
 */
class ExpectSelectedRadioOption implements FieldAssertionInterface
{
    ...
    /**
     * Fetches the value of the option expected to be selected within the radio group.
     */
